...
export const HELMET_STR_BASE_AFFIX_AFFIXES = [
  ...
  },
  {
    ...
    tier: "1",
    craftableAffix:
      "When dealing damage, inflicts Fire Infiltration . Interval for each enemy: 1s<> When Minions deal damage, inflicts Fire Infiltration . Interval for each enemy: 1s",
  },
  {
    equipmentSlot: "Helmet",
    equipmentType: "Helmet (STR)",
